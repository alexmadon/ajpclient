<span>Testing Alfresco using a python AJP client</span>
...
The AJPv13 specifications[@ajpv13] defines several variables that can
...
The first example shows a call using HTTP, and the second using HTTPS.
